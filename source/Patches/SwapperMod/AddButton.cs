...
namespace ProxyOfUs.SwapperMod
{
    [HarmonyPatch(typeof(MeetingHud), nameof(MeetingHud.Start))]
    public class AddButton
    {
        private static Sprite ActiveSprite => ProxyOfUs.SwapperSwitch;
        public static Sprite DisabledSprite => ProxyOfUs.SwapperSwitchDisabled;
        ...
        private static Action SetActive(Swapper role, int index)
        {
            void Listener()
            {
                ...
                _mostRecentId = index;
                PluginSingleton<ProxyOfUs>.Instance.Log.LogMessage(string.Join(" ", role.ListOfActives));
            }
