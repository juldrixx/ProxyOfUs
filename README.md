...
<details>
  ...
  <details>
    ...
    <ul> 
      <li> Reactor 2021.4.14s support </li>
      <li> Modifier text size </li>
      <li> New costume </li>
    </ul>
  </details>
  <details>
...
**1. Create a new folder on `Desktop`, called `Proxy of Us`.**\
...
\
**6. [Download](#releases) the Proxy of Us version corresponding to the installed Among Us version.**\
\
**7. Locate the downloaded `.zip` file, and move it to the `Proxy of Us` folder.**\
...
Something different might appear depending on the file manager being used. Make sure the folder gets extracted in the `Proxy of Us` folder, in the same location as the Among Us application. It should look similar to the picture below.\
\
**9. Launch the Among Us application that's inside, and start playing Proxy of Us!**\
